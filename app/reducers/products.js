...
const boxes = (state = initialState, action) => {
  switch (action.type) {
    case 'BULK_INSERT_PRODUCTS_FOR_IMPORT_PRODUCTS_REQUEST':
    case 'BULK_INSERT_MANUFACTURER_FOR_IMPORT_PRODUCTS_REQUEST':
    case 'BULK_INSERT_CATEGORIES_FOR_IMPORT_PRODUCTS_REQUEST':
    ...
    case 'BULK_INSERT_PRODUCTS_FOR_IMPORT_PRODUCTS_FAILED':
    case 'BULK_INSERT_PRODUCTS_FOR_IMPORT_PRODUCTS_SUCCESS':
    case 'BULK_INSERT_MANUFACTURER_FOR_IMPORT_PRODUCTS_FAILED':
    case 'BULK_INSERT_MANUFACTURER_FOR_IMPORT_PRODUCTS_SUCCESS':
    case 'BULK_INSERT_CATEGORIES_FOR_IMPORT_PRODUCTS_FAILED':
    case 'BULK_INSERT_CATEGORIES_FOR_IMPORT_PRODUCTS_SUCCESS':
